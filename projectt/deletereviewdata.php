...
?>
<?php
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delete_id2"])) {
    ...
    // Delete data from the "reviews" table based on the provided ID
    $sql = "DELETE FROM review WHERE id = $delete_id2";
