...
<body>
  ...
  <div class="room-description">
    ...
    <div class="room-info">
      <img src="./img/smart twin room.jpg" alt="Deluxe-Twin Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Discover comfort and convenience in our Deluxe Twin Rooms. Thoughtfully designed
          for your relaxation, these rooms offer spacious accommodation and modern amenities. Perfect for those seeking
          both comfort and functionality.</p>
        <h3 style="margin-bottom: 15px;">Max Capacity : <span style="color: grey;">6</span></h3>
        <h3>Amenities</h3>
        <ul type="square">
          <li>Two Twin Beds</li>
          ...
          <li>Free Wi-Fi</li>
          <li>Mini-Fridge/Refreshments</li>
        </ul>
