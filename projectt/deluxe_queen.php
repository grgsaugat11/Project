...
<body>
  ...
  <div class="room-description">
    ...
    <div class="room-info">
      <img src="./img/suite.jpg" alt="Swiss Select Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Experience luxury in our deluxe rooms. Thoughtfully designed with modern
          comforts and elegant décor, these spacious retreats offer a serene escape. Unwind in style and indulge in
          comfort, promising a stay that exceeds expectations.
        </p>
        ...
        <p><b style="color: grey;">Starting at $90 per night</b></p>
