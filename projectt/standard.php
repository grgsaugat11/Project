...
<body>
  ...
  <div class="room-description">
    <h2>Standard Room</h2>
    <div class="room-info">
      <img src="./img/room4.jpeg" alt="Standard Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Embrace comfort in our inviting standard rooms, designed for both leisure and
          business travelers seeking a cozy retreat. Enjoy modern amenities and a relaxing ambiance, ensuring a restful
          stay after a day of exploration or work.</p>
        <h3 style="margin-bottom: 15px;">Max Capacity : <span style="color: grey;">5</span></h3>
        <h3>Amenities</h3>
        <ul type="square">
          <li>2 Standard Beds</li>
        ...
        <p><b style="color: grey;">Starting at $60 per night</b></p>
