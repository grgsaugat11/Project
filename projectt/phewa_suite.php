...
<body>
  ...
  <div class="room-description">
    <h2>Phewa Suite</h2>
    <div class="room-info">
      <img src="./img/room5.jpg" alt="Phewa Suite">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Enjoy the convenience of separate living areas, stunning views, and premium
          furnishings, creating an oasis of relaxation and sophistication. Whether for leisure or business, our suites
          promise a memorable stay, blending style with unparalleled hospitality.</p>
        ...
        <p><b style="color: grey;">Starting at $130 per night</b></p>
