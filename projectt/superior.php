...
<body>
  ...
  <div class="room-description">
    ...
    <div class="room-info">
      <img src="./img/superior queen room 2.jpg" alt="Superior Queen Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Discover comfort and style in our Superior Queen Rooms, thoughtfully designed
          for your relaxation. Featuring a plush queen-sized bed and modern amenities, these rooms offer a cozy retreat
          during your stay.</p>
        <h3 style="margin-bottom: 15px;">Max Capacity : <span style="color: grey;">4</span></h3>
        <h3>Amenities</h3>
        <ul type="square">
          <li>Queen-sized bed</li>
          <li>Enhanced furnishings</li>
          <li>Air-Conditioner</li>
          <li>En-suite Bathroom</li>
          <li>Flat-screen TV</li>
          <li>24/7 Room Service</li>
          <li>Free Wi-Fi</li>
          <li>Coffee maker/tea kettle</li>
        </ul>
        <h3 style="margin-top: 15px;">Price</h3>
        <p><b style="color: grey;">Starting at $80 per night</b></p>
