...
<body>
  ...
  <div class="room-description">
    <h2>Family Room</h2>
    <div class="room-info">
      <img src="./img/room2.jpeg" alt="Family Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Designed with families in mind, our spacious family rooms offer comfort and
          convenience for every member. Featuring ample space and thoughtful amenities, these rooms ensure an enjoyable
          stay for your entire family.</p>
        <h3 style="margin-bottom: 15px;">Max Capacity : <span style="color: grey;">8</span></h3>
        <h3>Amenities</h3>
        <ul type="square">
          <li>Comfortable Seating</li>
          <li>Kid-Friendly Elements</li>
          <li>Air-Conditioner</li>
          <li>En-suite Bathroom</li>
          <li>Flat-screen TV/Gaming Console</li>
          <li>24/7 Room Service</li>
          <li>Free Wi-Fi</li>
          <li>Snack or Beverage Station</li>
        </ul>
        <h3 style="margin-top: 15px;">Price</h3>
        <p><b style="color: grey;">Starting at $70 per night</b></p>
