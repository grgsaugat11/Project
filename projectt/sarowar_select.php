...
<body>
  ...
  <div class="room-description">
    <h2>Sarowar Select Room</h2>
    <div class="room-info">
      <img src="./img/room6.jpg" alt="Sarowar Select Room">
      <div class="room-details">
        <h3>Description</h3>
        <p style="margin-bottom: 15px;">Indulge in luxury with our suites. Spaciously designed and elegantly appointed,
          our suites offer a refined escape, featuring modern amenities and exquisite comfort for an unforgettable stay.</p>
        ...
        <p><b style="color: grey;">Starting at $110 per night</b></p>
